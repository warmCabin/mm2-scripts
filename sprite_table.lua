...
local enemyNames = {
    [0x00] = "Shrimp A",
    [0x01] = "Shrimp B",
    [0x02] = "Shrimp spawner", -- Usually paired with Anko
    ...
    [0x0E] = "Bubble",
    [0x0F] = "Anko lantern",
    [0x10] = "Anko body", -- It's got the big invincible hitbox + fins, pupil, and gills (I bet you never noticed those gills)
    [0x11] = "Anko palette switcher",
    [0x12] = "Track platform",
    [0x13] = "Falling platform",
    [0x14] = "Quick laser manager",
    [0x15] = "Quick laser",
    [0x16] = "Bat",
    [0x1D] = "Big Monkey", -- Perhaps "Sizable Simian" would be more appropriate
    ...
    [0x60] = "Meatball",
    [0x63] = "Dragon block",
    [0x64] = "Dragon block spawner",
    [0x65] = "Dragon body",
    [0x66] = "Dragon tail", -- Dragon tail, Dragon tail, it's almost time for Dragon tail!
    [0x67] = "Dragon teleport",
    [0x68] = "Dragon fireball",
    [0x69] = "Guts hand",
    [0x6A] = "Picoblock",
    [0x6D] = "Bewb",
    [0x71] = "Scary fish",
